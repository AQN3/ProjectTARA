...
*  NB VGAx library does not work for newer software versions       * 
...
void processInputs() {
  ...
  buttonTwoStatus = digitalRead(BUTTON_2_PIN) || digitalRead(BUTTON_3_PIN); 
...
void drawingToy() {
  ...
  ballY = map(wheelTwoPosition, 1024, 0, VGAX_HEIGHT - 1, 1);
